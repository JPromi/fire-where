...
export default function FiredepartmentDetailScreen() {
  ...
  const [firedepartment, setFiredepartment] = useState<Firedepartment | undefined>(undefined);
          ...
          firedepartment ? (
                ...
                <Image
                  ...
                  <Pressable
                    ...
                    onPress={toggleFavourite}>
                      <IconSymbol
                        name="star.fill"
                        color={isFavourite ? Colors[colorScheme ?? 'light'].favourite : Colors[colorScheme ?? 'light'].text}
                        size={24}/>
                  </Pressable>
              </View>
            ...
            <>
              <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginBottom: dynamicSide.bottom + 50, gap: 10 }}>
                <FiredepartmentIcon height={32} width={32} color={Colors[colorScheme ?? 'light'].text}/>
                <Text style={{ color: Colors[colorScheme ?? 'light'].text, fontSize: 16 }}>{t('common.customError.firedepartmentNotFound')}</Text>
              </View>
            </>
          )
        )}
